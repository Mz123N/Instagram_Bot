# -*- coding: utf-8 -*-
"""
Created on Sun Apr  5 17:32:30 2020
...
class InstaBot:
    def __init__(self, username, pw):
        self.driver = webdriver.Chrome('/Users/mengn/Documents/chromedriver')
    ...
    def get_unfollowers(self):
        ...
        print(followers)
        Just_Following_me = [user for user in followers if user not in following]   
        print(Just_Following_me)
